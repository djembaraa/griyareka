        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button render={<Link href="/contact" />} nativeButton={false} size="lg" className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white border-none h-12 px-8 text-base cursor-pointer">
                Konsultasi Sekarang
              </Button>
              <Button render={<Link href="/properties" />} nativeButton={false} size="lg" variant="outline" className="w-full sm:w-auto bg-white/10 hover:bg-white/20 text-white border-white h-12 px-8 text-base backdrop-blur cursor-pointer">
                Lihat Portfolio
              </Button>
            </div>
          </MotionDiv>
